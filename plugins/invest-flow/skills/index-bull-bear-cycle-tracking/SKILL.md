---
name: index-bull-bear-cycle-tracking
...
输出目录：`./output/index-market-cycles/`

- 牛市：`bull-market-cycles-{CODE}.md`
- 熊市：`bear-market-cycles-{CODE}.md`
...
```bash
python plugins/invest-flow/skills/index-bull-bear-cycle-tracking/scripts/calculate_cycles.py \
...
- `assets/bull-market-cycles-template.md`：新指数牛市表模板。
- `assets/bear-market-cycles-template.md`：新指数熊市表模板。

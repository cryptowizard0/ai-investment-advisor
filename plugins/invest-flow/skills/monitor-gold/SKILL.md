...
- **Fixed cadence**: Run one complete gold monitor each week.
- **Supplemental triggers**: Rerun after material FOMC decisions or guidance, CPI surprises, significant real-rate moves, major geopolitical events, or abnormal gold-price moves.
- Supplemental runs use the same indicator groups and scoring model, and must identify the event that caused the early rerun.
...
2. **Generate base filename**: `monitor-gold-{analysis-type}-{date}`
   ...
   - Alternative: `monitor-gold-deep-scan-2026-01-28`

3. **Handle filename conflicts** (CRITICAL):
   - Check if `monitor-gold-{analysis-type}-{date}.md` already exists
   - If exists, append numbered suffix: `monitor-gold-{analysis-type}-{date}(1).md`
   - If that exists, increment: `monitor-gold-{analysis-type}-{date}(2).md`
...
- Input: `monitor-gold-bubble-risk-2026-01-28`
- No conflicts → Output: `monitor-gold-bubble-risk-2026-01-28.md`

**Second analysis of the same day**:
- Input: `monitor-gold-bubble-risk-2026-01-28`
- Conflict detected → Output: `monitor-gold-bubble-risk-2026-01-28(1).md`

**Third analysis**:
- Input: `monitor-gold-bubble-risk-2026-01-28`
- Conflicts: base and (1) exist → Output: `monitor-gold-bubble-risk-2026-01-28(2).md`

...
class CreateReportTests(unittest.TestCase):
    def test_writes_table_and_numbers_duplicate_paths(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            self.assertEqual(first_path.name, "index-pe-sensitivity-000688-2026-07-15.md")
            self.assertEqual(second_path.name, "index-pe-sensitivity-000688-2026-07-15(1).md")
    ...
    def test_percentile_placeholder_without_source(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            self.assertIn("index-pe-sensitivity-NDX-2026-07-14.md", path.name)

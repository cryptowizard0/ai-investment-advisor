...
输出目录：`./output/index-pe-sensitivity/`

## Trigger

在对话中使用：
- `/index-pe-sensitivity <指数>`
- 示例：`使用 invest-flow:index-pe-sensitivity 分析 科创50`
...
- 用脚本计算并生成报告骨架：
  - 序列法：`python plugins/invest-flow/skills/index-pe-sensitivity/scripts/generate_report.py --index 科创50 --code 000688 --base 232.5 --series-file series.txt --source "理杏仁·整体法"`
  - 锚点法：`... --base 232.5 --anchors "36.31:0,43.26:20,83.91:50,159.29:80,232.51:98.07,263.72:100" --current-percentile 98.07`
- 文件命名：`index-pe-sensitivity-{代码或指数}-{YYYY-MM-DD}.md`；重名自动追加 `(1)`、`(2)`。

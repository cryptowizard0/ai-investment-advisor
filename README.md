...
| `company-valuation-risk` | Type-gated valuation percentile band and risk: growth/cash-cow/toll-station gate → PE-vs-PS ruler selection with 100x-PE/40x-PS alert-line stops → 5-year TTM percentile band → potential risk = the worse of median-reversion and bear-low reference-point drawdowns. | You need to know how expensive a stock is vs its own 5-year history and how much downside pure valuation reversion implies. |

...
def get_unique_filename(directory: str, base_name: str, extension: str = ".md") -> str:
    ...
    Examples:
        如果 gold-risk-analysis-2026-01-28.md 已存在:
        - 第一次: gold-risk-analysis-2026-01-28(1).md
        - 第二次: gold-risk-analysis-2026-01-28(2).md
        - 以此类推...
    """
    # 确保目录存在
...
def main():
    ...
    if len(sys.argv) < 4:
        ...
        print("Example: python save_report.py ./output/gold-analysis gold-risk-2026-01-28 report.txt")
        sys.exit(1)

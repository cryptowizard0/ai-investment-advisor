---
name: institutional-accumulation-analysis
...
**Save Location:** `./output/institutional-accumulation-analysis/机构操作分析-{日期}-{股票名}.md`

**Example:** `./output/institutional-accumulation-analysis/机构操作分析-20260128-TSLA.md`
...
The script will:
- Create the `./output/institutional-accumulation-analysis/` directory if it doesn't exist
- Generate filename with format: `机构操作分析-{YYYYMMDD}-{TICKER}.md`
...
### scripts/
- **save_report.py** - Save analysis report to `./output/institutional-accumulation-analysis/机构操作分析-{日期}-{股票名}.md`
